...
const WA = 'https://wa.me/5491123867934?text=Hola!%20Quiero%20info%20sobre%20Calificar%20para%20mi%20restaurante.'

export const metadata: Metadata = {
  title: 'Calificar para Restaurantes — Más reseñas en Google sin esfuerzo',
  description:
    'Sistema de carteles QR y NFC para restaurantes, bares y cafeterías. Cada cliente satisfecho va directo a Google. Los problemas te llegan a vos, en privado. Sin apps, sin registros.',
  keywords: [
    'reseñas Google restaurante',
    'carteles QR reseñas restaurante',
    'aumentar reseñas Google bar',
    'sistema reseñas gastronomía Argentina',
    'QR NFC restaurante',
  ...
  openGraph: {
    title: 'Calificar para Restaurantes — Más reseñas en Google sin esfuerzo',
    description:
      'Carteles QR y NFC para gastronomía. Tus clientes satisfechos van directo a Google. Los problemas te llegan a vos, en privado.',
    url: 'https://calificar.com.ar/restaurantes',
    siteName: 'Calificar',
    locale: 'es_AR',
    type: 'website',
  },
  alternates: { canonical: 'https://calificar.com.ar/restaurantes' },
}
...
const PROBLEMS = [
  ...
  {
    emoji: '📉',
    title: 'Aparecer en Google Maps sin reseñas es invisible',
    desc: 'Los restaurantes con más de 100 reseñas y 4.5+ estrellas aparecen primero. Sin reseñas, tu local no existe para quien busca en Google.',
  },
]
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Depende del tamaño del local. Un restaurante chico con 2 carteles (uno en mesa y uno en el mostrador) ya nota la diferencia. Para locales más grandes recomendamos uno por cada 4-5 mesas.',
  },
  {
    q: '¿Realmente funciona el filtro de reseñas negativas?',
    a: 'Sí. Si el cliente elige "Mala experiencia" o similar, el sistema le muestra un formulario para que te cuente qué pasó. No lo lleva a Google. Vos recibís el mensaje y podés responder.',
  },
  {
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-lg sm:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
            Un cartel en la mesa o el mostrador. El cliente lo escanea. Los que quedaron conformes van directo a Google. Los que tuvieron un problema te escriben a vos, en privado. Sin apps, sin complicaciones.
          </p>
          ...
          <div className="mt-12 flex flex-wrap gap-6 justify-center text-sm text-gray-400">
            <span className="flex items-center gap-2">⭐ Reseñas reales en Google</span>
            <span className="flex items-center gap-2">📡 QR + NFC incluido</span>
            <span className="flex items-center gap-2">🔄 Sin reimprimir si cambiás el link</span>
            <span className="flex items-center gap-2">⚡ Activo en minutos</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="font-extrabold text-3xl sm:text-4xl text-gray-900 mb-4">
              Los problemas que tiene todo restaurante en Google
            </h2>
      ...
      <section className="py-16 px-6 bg-violet-600">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-violet-200 text-lg mb-8">
            Un restaurante con 30 clientes por día puede conseguir entre 5 y 15 reseñas nuevas por semana con Calificar. Sin pedirle nada al cliente.
          </p>
          <a href={WA}
      ...
      <footer className="border-t border-gray-100 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm text-gray-400">
            <Link href="/restaurantes" className="hover:text-gray-600 transition-colors font-semibold text-violet-600">Restaurantes</Link>
