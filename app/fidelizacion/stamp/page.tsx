      ...
      {status === 'success' && (() => {
        ...
        return (
          <div className="flex flex-col items-center gap-5 max-w-xs w-full">
            ...
            {walletObjectId && (
              <a
                href={`intent://pay.google.com/gp/v/object/${walletObjectId}#Intent;scheme=https;package=com.google.android.apps.walletnfcrel;action=android.intent.action.VIEW;end`}
                className="flex items-center gap-2 bg-zinc-900 text-white text-sm font-semibold px-5 py-3 rounded-2xl hover:bg-zinc-800 transition-colors"
              >
