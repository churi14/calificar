...
function WalletButton({ objectId }: { objectId: string }) {
  const webUrl = `https://pay.google.com/gp/v/object/${objectId}`
  const intentUrl = `intent://pay.google.com/gp/v/object/${objectId}#Intent;scheme=https;package=com.google.android.apps.walletnfcrel;action=android.intent.action.VIEW;S.browser_fallback_url=${encodeURIComponent(webUrl)};end`
  return (
    <a
      href={intentUrl}
